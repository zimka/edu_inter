"""
Django settings for edu_inter project.
...
SECRET_KEY = '^n7i=rua$@pe#vz8&33#-fruwrmhd^7!sr11&(nzql$&&43iqr'
...
WSGI_APPLICATION = 'edu_inter.wsgi.application'
